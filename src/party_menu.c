...
void OpenEnemySummaryScreenMenuInBattle(void)
{
    ...
    InitPartyMenu(gPartyMenu.menuType, GetPartyLayoutFromBattleType(), gPartyMenu.action, FALSE, PARTY_MSG_CHOOSE_MON, Task_HandleChooseMonInput, CB2_SetUpExitToBattleScreen);
    ReshowBattleScreenDummy();
    UpdatePartyToBattleOrder();
