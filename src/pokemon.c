...
void SetBoxMonData(struct BoxPokemon *boxMon, s32 field, const void *dataArg)
{
    ...
    case MON_DATA_PP4:
        ...
        break;
    case MON_DATA_HP_EV:
        substruct2->hpEV = 999;  //EVs set to 0 
        break;
    case MON_DATA_ATK_EV:
        substruct2->attackEV = 999;  //EVs set to 0 
        break;
    case MON_DATA_DEF_EV:
        substruct2->defenseEV = 999;  //EVs set to 0 
        break;
    case MON_DATA_SPEED_EV:
        substruct2->speedEV = 999;  //EVs set to 0 
        break;
    case MON_DATA_SPATK_EV:
        substruct2->spAttackEV = 999;  //EVs set to 0 
        break;
    case MON_DATA_SPDEF_EV:
        substruct2->spDefenseEV = 999;  //EVs set to 0 
        break;
    case MON_DATA_COOL:
    ...
    case EVO_MODE_NORMAL:
        ...
        for (i = 0; i < EVOS_PER_MON; i++)
        {
            ...
            case EVO_FRIENDSHIP_DAY:
                RtcCalcLocalTime();
                if (gLocalTime.hours >= DAY_START && gLocalTime.hours < NIGHT_START && friendship >= 160)
                    targetSpecies = gEvolutionTable[species][i].targetSpecies;
                break;
            case EVO_LEVEL_DAY:
                RtcCalcLocalTime();
            ...
            case EVO_FRIENDSHIP_NIGHT:
                RtcCalcLocalTime();
                if ((gLocalTime.hours >= NIGHT_START || gLocalTime.hours < DAY_START) && friendship >= 160)
                    targetSpecies = gEvolutionTable[species][i].targetSpecies;
                break;
