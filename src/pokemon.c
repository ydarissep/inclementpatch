...
void SetBoxMonData(struct BoxPokemon *boxMon, s32 field, const void *dataArg)
{
    ...
    case MON_DATA_PP4:
        ...
        break;
    case MON_DATA_HP_EV:
        substruct2->hpEV = 252;  //EVs set to 0 
        break;
    case MON_DATA_ATK_EV:
        substruct2->attackEV = 252;  //EVs set to 0 
        break;
    case MON_DATA_DEF_EV:
        substruct2->defenseEV = 252;  //EVs set to 0 
        break;
    case MON_DATA_SPEED_EV:
        substruct2->speedEV = 252;  //EVs set to 0 
        break;
    case MON_DATA_SPATK_EV:
        substruct2->spAttackEV = 252;  //EVs set to 0 
        break;
    case MON_DATA_SPDEF_EV:
        substruct2->spDefenseEV = 252;  //EVs set to 0 
        break;
    case MON_DATA_COOL:
