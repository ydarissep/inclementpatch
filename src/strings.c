...
const u8 gText_dexStone[] = _("Stone");
const u8 gText_dexKnuckle[] = _("Knuckle");
const u8 gText_dexDynamo[] = _("Dynamo");
const u8 gText_dexHeat[] = _("Heat");
const u8 gText_dexBalance[] = _("Balance");
const u8 gText_dexFeather[] = _("Feather");
const u8 gText_dexMind[] = _("Mind");
//const u8 gText_dexRain[] = _("Rain");
const u8 gText_dexTutor[] = _("Tutor");
...
const u8 gText_EggGenerated[] = _("{PLAYER} found a Pokémon egg and \nplaced it in the Egg Incubator.{PAUSE_UNTIL_PRESS}");
const u8 gText_YourPartysFullPause[] = _("Your party's full!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NumberVar1Clear8Var2[] = _("{NO}{STR_VAR_1}{CLEAR 0x0C}{STR_VAR_2}");
...
const u8 gText_ShopAlreadyHaveTM[] = _("You already have that TM!{PAUSE_UNTIL_PRESS}");
const u8 gText_ShopPurchasedTMPrice[] = _("---");
...
const u8 gText_RibbonsVar1[] = _("{STR_VAR_1}");
...
const u8 gText_GameCornerVulpix[] = 	_("Vulpix{CLEAR_TO 0x48}2000 Coins");
const u8 gText_GameCornerSandshrew[] = 	_("Sandshrew{CLEAR_TO 0x48}2000 Coins");
const u8 gText_GameCornerRattata[] = 	_("Rattata{CLEAR_TO 0x48}1000 Coins");
const u8 gText_GameCornerMeowth[] = 	_("Meowth{CLEAR_TO 0x48}2000 Coins");
