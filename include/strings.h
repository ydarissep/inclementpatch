...
extern const u8 gText_CherishBalls[];
...
extern const u8 gText_BirchStrictCaps[];
...
extern const u8 gText_dexStone[];
extern const u8 gText_dexKnuckle[];
extern const u8 gText_dexDynamo[];
extern const u8 gText_dexHeat[];
extern const u8 gText_dexBalance[];
...
extern const u8 gText_YourPartysFullPause[];
...
extern const u8 gText_VacuumWave[];
...
extern const u8 gText_Brine[];
extern const u8 gText_RazorShell[];
extern const u8 gText_Revenge[];
...
extern const u8 gText_MysticalFire[];
extern const u8 gText_GunkShot[];
...
extern const u8 gText_Liquidation[];
extern const u8 gText_BatonPass[];
extern const u8 gText_FoulPlay[];
extern const u8 gText_SolarBlade[];
extern const u8 gText_PhantomForce[];
extern const u8 gText_MeteorMash[];
...
extern const u8 gText_SelfDestruct[];
extern const u8 gText_CloseCombat[];
extern const u8 gText_FlareBlitz[];
...
extern const u8 PokemonCenterMoveTutor_Text_CovetDesc[];
extern const u8 PokemonCenterMoveTutor_Text_VacuumWaveDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ShockWaveDesc[];
extern const u8 PokemonCenterMoveTutor_Text_BugBiteDesc[];
extern const u8 PokemonCenterMoveTutor_Text_AirCutterDesc[];
extern const u8 PokemonCenterMoveTutor_Text_SwiftDesc[];
extern const u8 PokemonCenterMoveTutor_Text_SnatchDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_EndeavorDesc[];
extern const u8 PokemonCenterMoveTutor_Text_WorrySeedDesc[];
extern const u8 PokemonCenterMoveTutor_Text_DefenseCurlDesc[];
extern const u8 PokemonCenterMoveTutor_Text_DefogDesc[];
extern const u8 PokemonCenterMoveTutor_Text_MagicCoatDesc[];
extern const u8 PokemonCenterMoveTutor_Text_UproarDesc[];
extern const u8 PokemonCenterMoveTutor_Text_HexDesc[];
extern const u8 PokemonCenterMoveTutor_Text_GastroAcidDesc[];
extern const u8 PokemonCenterMoveTutor_Text_SynthesisDesc[];
extern const u8 PokemonCenterMoveTutor_Text_PainSplitDesc[];
extern const u8 PokemonCenterMoveTutor_Text_LowKickDesc[];
extern const u8 PokemonCenterMoveTutor_Text_IronDefenseDesc[];
extern const u8 PokemonCenterMoveTutor_Text_MagnetRiseDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_GravityDesc[];
extern const u8 PokemonCenterMoveTutor_Text_SeedBombDesc[];
extern const u8 PokemonCenterMoveTutor_Text_PsychoCutDesc[];
extern const u8 PokemonCenterMoveTutor_Text_IcyWindDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ElectroWebDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ThunderFangDesc[];
extern const u8 PokemonCenterMoveTutor_Text_FireFangDesc[];
extern const u8 PokemonCenterMoveTutor_Text_IceFangDesc[];
extern const u8 PokemonCenterMoveTutor_Text_BrineDesc[];
extern const u8 PokemonCenterMoveTutor_Text_RazorShellDesc[];
extern const u8 PokemonCenterMoveTutor_Text_RevengeDesc[];
extern const u8 PokemonCenterMoveTutor_Text_DrainingKissDesc[];
extern const u8 PokemonCenterMoveTutor_Text_LeafBladeDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_TailwindDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ZenHeadbuttDesc[];
extern const u8 PokemonCenterMoveTutor_Text_BodySlamDesc[];
extern const u8 PokemonCenterMoveTutor_Text_IcicleSpearDesc[];
extern const u8 PokemonCenterMoveTutor_Text_DualChopDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ReversalDesc[];
extern const u8 PokemonCenterMoveTutor_Text_BugBuzzDesc[];
extern const u8 PokemonCenterMoveTutor_Text_LastResortDesc[];
extern const u8 PokemonCenterMoveTutor_Text_RolePlayDesc[];
extern const u8 PokemonCenterMoveTutor_Text_DrillRunDesc[];
extern const u8 PokemonCenterMoveTutor_Text_BlazeKickDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_AquaTailDesc[];
extern const u8 PokemonCenterMoveTutor_Text_PowerGemDesc[];
extern const u8 PokemonCenterMoveTutor_Text_BounceDesc[];
extern const u8 PokemonCenterMoveTutor_Text_HealBellDesc[];
extern const u8 PokemonCenterMoveTutor_Text_SuperpowerDesc[];
extern const u8 PokemonCenterMoveTutor_Text_CrunchDesc[];
extern const u8 PokemonCenterMoveTutor_Text_MysticalFireDesc[];
extern const u8 PokemonCenterMoveTutor_Text_GunkShotDesc[];
extern const u8 PokemonCenterMoveTutor_Text_HyperVoiceDesc[];
extern const u8 PokemonCenterMoveTutor_Text_SkyAttackDesc[];
extern const u8 PokemonCenterMoveTutor_Text_HeatCrashDesc[];
extern const u8 PokemonCenterMoveTutor_Text_StoredPowerDesc[];
extern const u8 PokemonCenterMoveTutor_Text_TrickDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_AuraSphereDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ThroatChopDesc[];
extern const u8 PokemonCenterMoveTutor_Text_EarthPowerDesc[];
extern const u8 PokemonCenterMoveTutor_Text_HeatWaveDesc[];
extern const u8 PokemonCenterMoveTutor_Text_LiquidationDesc[];
extern const u8 PokemonCenterMoveTutor_Text_BatonPassDesc[];
extern const u8 PokemonCenterMoveTutor_Text_FoulPlayDesc[];
extern const u8 PokemonCenterMoveTutor_Text_SolarBladeDesc[];
extern const u8 PokemonCenterMoveTutor_Text_PhantomForceDesc[];
extern const u8 PokemonCenterMoveTutor_Text_MeteorMashDesc[];
extern const u8 PokemonCenterMoveTutor_Text_PsychicFangsDesc[];
extern const u8 PokemonCenterMoveTutor_Text_EncoreDesc[];
extern const u8 PokemonCenterMoveTutor_Text_GrassyTerrainDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_PlayRoughDesc[];
extern const u8 PokemonCenterMoveTutor_Text_NastyPlotDesc[];
extern const u8 PokemonCenterMoveTutor_Text_SelfDestructDesc[];
extern const u8 PokemonCenterMoveTutor_Text_CloseCombatDesc[];
extern const u8 PokemonCenterMoveTutor_Text_FlareBlitzDesc[];
extern const u8 PokemonCenterMoveTutor_Text_BraveBirdDesc[];
extern const u8 PokemonCenterMoveTutor_Text_LeafStormDesc[];
extern const u8 PokemonCenterMoveTutor_Text_PowerWhipDesc[];
extern const u8 PokemonCenterMoveTutor_Text_HurricaneDesc[];
extern const u8 PokemonCenterMoveTutor_Text_HydroPumpDesc[];
